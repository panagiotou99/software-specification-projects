...
ltl p1 { []<> (ship_did_request_but_not_fulfilled[0] == false) } /*  */
...
// Make sure ship enters lock after request
bool ship_did_request_but_not_fulfilled[M];
...
proctype ship(byte shipid) {
	ship_did_request_but_not_fulfilled[shipid] = false
	do
	:: ship_status[shipid] == go_down && ship_pos[shipid] != 0 ->
		do
		:: doors_status.higher == closed ->
			ship_did_request_but_not_fulfilled[shipid] = true
			request_high!true;
